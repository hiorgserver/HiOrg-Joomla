...
Sie müssen nun in der <a href="?option=com_dpcalendar&view=tools&layout=import">DPCalendar-Konfiguration</a> ihre HiOrg-Server Termine in einen Kalender importieren.
';
} ?>  
